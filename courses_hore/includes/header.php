...
<style>
    * {
    ...
    .btn-signup {
        ...
        color: white;
        border: none;
        background: linear-gradient(135deg, #8A2BE2, #6a1ab8);
    }

    .btn-signup:hover {
        background: linear-gradient(135deg, #6a1ab8, #5a1899);
    ...
    @media (max-width: 1150px) {
        ...
        /* Hide desktop profile image on mobile */
        .desktop-only .acc-user-avatar {
            display: none;
        }
        
        /* Adjust buttons for mobile */
        .navbar-right.mobile-only .btn-login,
        .navbar-right.mobile-only .btn-signup {
            padding: 10px 20px;
            width: 150px;
            text-align: center;
        }
...
<header class="navbar" id="navbarHeader">
    ...
    <nav class="navbar-center" id="mainMenu">
        <ul>
            ...
            <li><a href="../workshops/workshops.php" class="<?php echo ($current_page == 'workshops.php') ? 'active' : ''; ?>">Workshops</a></li>
            <li><a href="courses.php" class="<?php echo ($current_page == 'courses.php'|| $current_page == 'introduction to potter.php' || $current_page == 'modern calligraphy.php' || $current_page == 'modern digital painting.php' || $current_page == 'oil painting masterclass.php' || $current_page == 'portrait drawing with charcoal.php') ? 'active' : ''; ?>">Courses</a></li>
        ...
        <div class="mobile-user-profile">
            <a href="../students/acc-account.php">
        ...
        <div class="navbar-right mobile-only">
            ...
            <?php else: ?>
                <a href="../students/signin.php" class="btn-login <?php echo ($current_page == 'signin.php') ? 'active' : ''; ?>">Signin</a>
                <a href="../students/signUp.php" class="btn-signup <?php echo ($current_page == 'signUp.php') ? 'active' : ''; ?>">SignUp</a>
            <?php endif; ?>
        </div>
    </nav>
