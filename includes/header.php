...
<header class="navbar" id="navbarHeader">
    ...
    <nav class="navbar-center" id="mainMenu">
        <ul>
            ...
            <li><a href="gallery/maslah_gallery.php" class="<?php echo ($current_page == 'gallery.php') ? 'active' : ''; ?>">Gallery</a></li>
        ...
        <div class="navbar-right mobile-only">
            ...
            <?php else: ?>
                <a href="students/signin.php" class="btn-login <?php echo ($current_page == 'signin.php') ? 'active' : ''; ?>">Login</a>
    ...
    <div class="navbar-right desktop-only">
        ...
        <?php if (isset($_SESSION['username'])): ?>
            <a href="includes/logout.php" class="btn-login">Logout</a>
