...
<header class="navbar" id="navbarHeader">
    ...
    <nav class="navbar-center" id="mainMenu">
        <ul>
            ...
            <li><a href="courses.php" class="<?php echo ($current_page == 'courses.php' || $current_page == 'course-details.php') ? 'active' : ''; ?>">Courses</a></li>
        ...
        <div class="navbar-right mobile-only">
            ...
            <?php else: ?>
                <a href="../students/sign.php" class="btn-login">Login</a>
