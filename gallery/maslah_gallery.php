<?php 
    ...
    try {
        ...
        // Fetch teacher artworks (same query as in admin gallery-teacher.php)
        $stmt = $pdo->prepare("
            ...
            WHERE aw.gallery_type = 'teacher' 
            ORDER BY aw.uploaded_at DESC
        ");
        $stmt->execute();
        $teacherArtworks = $stmt->fetchAll();
    } catch (PDOException $e) {
        error_log("Database error: " . $e->getMessage());
        $teacherArtworks = []; // Empty array if there's an error
    }

    // Calculate total pages needed
    $itemsPerPage = 6; // 2 rows of 3 cards each
    $totalItems = count($teacherArtworks);
    ...
    $heroSlides = [
        [
            ...
            'description' => 'Discover exceptional artwork from our talented teachers.'
        ],
        [
            'image' => 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwa90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1450&q=80',
            'title' => 'Artistic Excellence',
            'description' => 'Experience the creative mastery of our teaching artists.'
        ],
        [
            ...
            'description' => 'Find inspiration in the diverse works of our educators.'
        ],
        [
            ...
            'description' => 'Witness the skill and expertise of our teaching staff.'
        ],
        [
            ...
            'title' => 'Art Education',
            'description' => 'Celebrating the intersection of teaching and artistic practice.'
        ]
    ];
?>
...
<head>
    ...
    <title>Teacher Gallery - Maslax Arts</title>
...
<body>
        ...
        <div class="gallery-section-wrapper-unique">
            <div class="category-tabs">
                <div class="category-container">
                    <a href="../gallery/student_gallery.php"><button class="category-btn active">Student Gallery</button></a>
                </div>
            </div>
            ...
            <div class="gallery-container">
                <div class="gallery-grid" id="galleryContent">
                    <?php if (!empty($teacherArtworks)): ?>
                        <?php 
                        // Show only first 6 items initially
                        $initialItems = array_slice($teacherArtworks, 0, $itemsPerPage);
                        ?>
                        <?php foreach ($initialItems as $index => $artwork): ?>
                            <div class="gallery-item" data-category="teacher" style="animation-delay: <?php echo $index * 0.1; ?>s">
            ...
            <!-- Pagination Controls - Always show buttons -->
    ...
    <script>
        ...
        const allArtworks = <?php echo json_encode($teacherArtworks); ?>;
        const itemsPerPage = <?php echo $itemsPerPage; ?>;
        const galleryType = 'teacher';
    </script>
