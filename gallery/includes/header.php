...
<header class="navbar" id="navbarHeader">
    ...
    <nav class="navbar-center" id="mainMenu">
        <ul>
            ...
            <li><a href="maslah_gallery.php" class="<?php echo ($current_page == 'maslah_gallery.php' || $current_page == 'student_gallery.php' || strpos($_SERVER['REQUEST_URI'], 'gallery/') !== false) ? 'active' : ''; ?>">Gallery</a></li>
