...
<style>
    * {
    ...
    .navbar-center.fullscreen-menu {
        ...
        /* marka laga reebo height-ka header-ka */
...
<header class="navbar" id="navbarHeader">
    ...
    <nav class="navbar-center" id="mainMenu">
        <ul>
            ...
            <li><a href="../courses/courses.php" class="<?php echo ($current_page == 'courses.php'|| $current_page == 'introduction to potter.php' || $current_page == 'modern calligraphy.php' || $current_page == 'modern digital painting.php' || $current_page == 'oil painting masterclass.php' || $current_page == 'portrait drawing with charcoal.php') ? 'active' : ''; ?>">Courses</a></li>
            <li><a href="../Maslah_Art_System/events/event.php" class="<?php echo ($current_page == 'event.php') ? 'active' : ''; ?>">Event</a></li>
        ...
        <div class="navbar-right mobile-only">
            ...
            <?php else: ?>
                <li><a href="students/signin.php" class="btn-login" class="<?php echo ($current_page == 'signin.php') ? 'active' : ''; ?>">signin</a></li>
                <li><a href="students/signUp.php" class="btn-login" class="<?php echo ($current_page == 'signUp.php') ? 'active' : ''; ?>">Signup</a></li>
            <?php endif; ?>
        </div>
    </nav>
